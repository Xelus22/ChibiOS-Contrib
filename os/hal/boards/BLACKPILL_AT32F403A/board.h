/*
    ...
    ChibiOS - Copyright (C) 2006..2022 Harrison Chan
...
/*
 * Setup for the WeAct Blackpill AT32F403A board.
 */

/*
 * Board identifier.
 */
#define BOARD_AT_BLACKPILL_AT32F403A
#define BOARD_NAME              "WeAct Blackpill F403A"

/*
 * Board frequencies.
 */
#define AT32_LSECLK            32768

#if defined(BLACKPILL_EXTERNAL_OSCILLATOR)
#define AT32_HSECLK            25000000
#define AT32_HSE_BYPASS

#elif defined(BLACKPILL_HSE_CRYSTAL)
#define AT32_HSECLK            25000000

#else
#define AT32_HSECLK            0
#endif
