 ...
 * @brief   AT32 CAN subsystem low level driver header.
 *
 * @addtogroup CAN
 * @{
 */
 ...
 */
#if !defined(AT32_CAN_REPORT_ALL_ERRORS) || defined(__DOXYGEN__)
#define AT32_CAN_REPORT_ALL_ERRORS         FALSE
#endif
 ...
 */
#if !defined(AT32_CAN_USE_CAN1) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AT32_CAN_USE_CAN2) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AT32_CAN_USE_CAN3) || defined(__DOXYGEN__)
#define AT32_CAN_USE_CAN3                  FALSE
#endif

/**
 * @brief   CAN1 interrupt priority level setting.
 */
#if !defined(AT32_CAN_CAN1_IRQ_PRIORITY) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AT32_CAN_CAN2_IRQ_PRIORITY) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AT32_CAN_CAN3_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_CAN_CAN3_IRQ_PRIORITY         11
#endif
/** @} */
...
#if !defined(AT32_HAS_CAN1)
#error "AT32_HAS_CAN1 not defined in registry"
#endif

#if !defined(AT32_HAS_CAN2)
#error "AT32_HAS_CAN2 not defined in registry"
#endif

#if !defined(AT32_HAS_CAN3)
#error "AT32_HAS_CAN3 not defined in registry"
#endif

#if (AT32_HAS_CAN1 | AT32_HAS_CAN2) && !defined(AT32_CAN_MAX_FILTERS)
#error "AT32_CAN_MAX_FILTERS not defined in registry"
#endif

#if AT32_HAS_CAN3 && !defined(AT32_CAN3_MAX_FILTERS)
#error "AT32_CAN3_MAX_FILTERS not defined in registry"
#endif

#if AT32_CAN_USE_CAN1 && !AT32_HAS_CAN1
#error "CAN1 not present in the selected device"
#endif

#if AT32_CAN_USE_CAN2 && !AT32_HAS_CAN2
#error "CAN2 not present in the selected device"
#endif

#if AT32_CAN_USE_CAN3 && !AT32_HAS_CAN3
#error "CAN2 not present in the selected device"
#endif

#if !AT32_CAN_USE_CAN1 && !AT32_CAN_USE_CAN2 && !AT32_CAN_USE_CAN3
...
/**
 * @brief   CAN filter.
 * @note    Refer to the AT32 reference manual for info about filters.
 */
typedef struct {
  /**
