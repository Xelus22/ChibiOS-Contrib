 ...
 * @brief   AT32 CAN subsystem low level driver source.
 *
 * @addtogroup CAN
 * @{
 */
...
#if AT32_CAN_USE_CAN1 || defined(__DOXYGEN__)
CANDriver CAND1;
#endif

/** @brief CAN2 driver identifier.*/
#if AT32_CAN_USE_CAN2 || defined(__DOXYGEN__)
CANDriver CAND2;
#endif

/** @brief CAN3 driver identifier.*/
#if AT32_CAN_USE_CAN3 || defined(__DOXYGEN__)
CANDriver CAND3;
#endif
...
#if AT32_CAN_USE_CAN1
    if (canp == &CAND1) {
      for (i = 0; i < AT32_CAN_MAX_FILTERS; i++) {
...
#if AT32_CAN_USE_CAN3
    if (canp == &CAND3) {
      for (i = 0; i < AT32_CAN3_MAX_FILTERS; i++) {
        canp->can->sFilterRegister[i].FR1 = 0;
        canp->can->sFilterRegister[i].FR2 = 0;
      }
    }
...
#if AT32_CAN_USE_CAN1 || defined(__DOXYGEN__)
#if defined(AT32_CAN1_UNIFIED_HANDLER)
/**
 * @brief   CAN1 unified interrupt handler.
 *
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN1_UNIFIED_HANDLER) {
...
#else /* !defined(AT32_CAN1_UNIFIED_HANDLER) */

#if !defined(AT32_CAN1_TX_HANDLER)
#error "AT32_CAN1_TX_HANDLER not defined"
#endif
#if !defined(AT32_CAN1_RX0_HANDLER)
#error "AT32_CAN1_RX0_HANDLER not defined"
#endif
#if !defined(AT32_CAN1_RX1_HANDLER)
#error "AT32_CAN1_RX1_HANDLER not defined"
#endif
#if !defined(AT32_CAN1_SCE_HANDLER)
#error "AT32_CAN1_SCE_HANDLER not defined"
#endif
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN1_TX_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN1_RX0_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN1_RX1_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN1_SCE_HANDLER) {
...
#endif /* !defined(AT32_CAN1_UNIFIED_HANDLER) */
#endif /* AT32_CAN_USE_CAN1 */

#if AT32_CAN_USE_CAN2 || defined(__DOXYGEN__)
#if defined(AT32_CAN2_UNIFIED_HANDLER)
/**
 * @brief   CAN1 unified interrupt handler.
 *
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN2_UNIFIED_HANDLER) {
...
#else /* !defined(AT32_CAN2_UNIFIED_HANDLER) */
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN2_TX_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN2_RX0_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN2_RX1_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN2_SCE_HANDLER) {
...
#endif /* !defined(AT32_CAN2_UNIFIED_HANDLER) */
#endif /* AT32_CAN_USE_CAN2 */

#if AT32_CAN_USE_CAN3 || defined(__DOXYGEN__)
#if defined(AT32_CAN3_UNIFIED_HANDLER)
/**
 * @brief   CAN1 unified interrupt handler.
 *
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN3_UNIFIED_HANDLER) {
...
#else /* !defined(AT32_CAN3_UNIFIED_HANDLER) */

#if !defined(AT32_CAN3_TX_HANDLER)
#error "AT32_CAN3_TX_HANDLER not defined"
#endif
#if !defined(AT32_CAN3_RX0_HANDLER)
#error "AT32_CAN3_RX0_HANDLER not defined"
#endif
#if !defined(AT32_CAN3_RX1_HANDLER)
#error "AT32_CAN3_RX1_HANDLER not defined"
#endif
#if !defined(AT32_CAN3_SCE_HANDLER)
#error "AT32_CAN3_SCE_HANDLER not defined"
#endif
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN3_TX_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN3_RX0_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN3_RX1_HANDLER) {
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AT32_CAN3_SCE_HANDLER) {
...
void can_lld_init(void) {
  ...
  canObjectInit(&CAND1);
  CAND1.can = CAN1;
#if defined(AT32_CAN1_UNIFIED_NUMBER)
    nvicEnableVector(AT32_CAN1_UNIFIED_NUMBER, AT32_CAN_CAN1_IRQ_PRIORITY);
#else
    nvicEnableVector(AT32_CAN1_TX_NUMBER, AT32_CAN_CAN1_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN1_RX0_NUMBER, AT32_CAN_CAN1_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN1_RX1_NUMBER, AT32_CAN_CAN1_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN1_SCE_NUMBER, AT32_CAN_CAN1_IRQ_PRIORITY);
#endif
#endif
  ...
  canObjectInit(&CAND2);
  CAND2.can = CAN2;
#if defined(AT32_CAN2_UNIFIED_NUMBER)
    nvicEnableVector(AT32_CAN2_UNIFIED_NUMBER, AT32_CAN_CAN2_IRQ_PRIORITY);
#else
    nvicEnableVector(AT32_CAN2_TX_NUMBER, AT32_CAN_CAN2_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN2_RX0_NUMBER, AT32_CAN_CAN2_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN2_RX1_NUMBER, AT32_CAN_CAN2_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN2_SCE_NUMBER, AT32_CAN_CAN2_IRQ_PRIORITY);
#endif
#endif
  ...
  canObjectInit(&CAND3);
  CAND3.can = CAN3;
#if defined(AT32_CAN3_UNIFIED_NUMBER)
    nvicEnableVector(AT32_CAN3_UNIFIED_NUMBER, AT32_CAN_CAN3_IRQ_PRIORITY);
#else
    nvicEnableVector(AT32_CAN3_TX_NUMBER, AT32_CAN_CAN3_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN3_RX0_NUMBER, AT32_CAN_CAN3_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN3_RX1_NUMBER, AT32_CAN_CAN3_IRQ_PRIORITY);
    nvicEnableVector(AT32_CAN3_SCE_NUMBER, AT32_CAN_CAN3_IRQ_PRIORITY);
#endif
#endif
...
#if AT32_CAN_USE_CAN1
#if AT32_HAS_CAN2
  can_lld_set_filters(&CAND1, AT32_CAN_MAX_FILTERS / 2, 0, NULL);
#else
  can_lld_set_filters(&CAND1, AT32_CAN_MAX_FILTERS, 0, NULL);
#endif
#endif

#if AT32_HAS_CAN3
#if AT32_CAN_USE_CAN3
  can_lld_set_filters(&CAND3, AT32_CAN3_MAX_FILTERS, 0, NULL);
#endif
#endif
}
 ...
 * @note    This is an AT32-specific API.
 *
 * @param[in] canp      pointer to the @p CANDriver object
 * @param[in] can2sb    number of the first filter assigned to CAN2
 * @param[in] num       number of entries in the filters array, if zero then
 ...
 * @api
 */
void canAT32SetFilters(CANDriver *canp, uint32_t can2sb,
                        uint32_t num, const CANFilter *cfp) {

#if AT32_CAN_USE_CAN2
  osalDbgCheck((can2sb <= AT32_CAN_MAX_FILTERS) &&
               (num <= AT32_CAN_MAX_FILTERS));
#endif
