 ...
 * @{
 */
#define AT32_IWDG_RL_MASK                  (0x00000FFF << 0)
#define AT32_IWDG_RL(n)                    ((n) << 0)
/** @} */
 ...
 * @{
 */
#define AT32_IWDG_PR_MASK                  (7 << 0)
#define AT32_IWDG_PR_4                     0U
#define AT32_IWDG_PR_8                     1U
#define AT32_IWDG_PR_16                    2U
#define AT32_IWDG_PR_32                    3U
#define AT32_IWDG_PR_64                    4U
#define AT32_IWDG_PR_128                   5U
#define AT32_IWDG_PR_256                   6U
/** @} */
 ...
 * @{
 */
#define AT32_IWDG_WIN_MASK                 (0x00000FFF << 0)
#define AT32_IWDG_WIN(n)                   ((n) << 0)
#define AT32_IWDG_WIN_DISABLED             AT32_IWDG_WIN(0x00000FFF)
/** @} */
 ...
 */
#if !defined(AT32_WDG_USE_IWDG) || defined(__DOXYGEN__)
...
#if AT32_WDG_USE_IWDG && !AT32_HAS_IWDG
#error "IWDG not present in the selected device"
#endif

#if !AT32_WDG_USE_IWDG
#error "WDG driver activated but no xWDG peripheral assigned"
#endif

#if !defined(AT32_LSI_ENABLED)
#error "AT32_LSI_ENABLED not defined"
#endif

#if (AT32_WDG_USE_IWDG == TRUE) && (AT32_LSI_ENABLED == FALSE)
...
typedef struct {
   ...
   */
  uint32_t    rlr;
#if AT32_IWDG_IS_WINDOWED || defined(__DOXYGEN__)
  /**
...
#if AT32_WDG_USE_IWDG && !defined(__DOXYGEN__)
