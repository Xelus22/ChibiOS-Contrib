...
/**
 * @file    AT32F1xx/hal_adc_lld.c
 * @brief   AT32F1xx ADC subsystem low level driver source.
 *
 * @addtogroup ADC
 * @{
 */
...
void adc_lld_init(void) {
  ...
  ADCD2.adc = ADC2;
  ADCD2.dmastp  = NULL;
  ADCD2.dmamode = AT32_DMA_CR_PL(AT32_ADC_ADC2_DMA_PRIORITY) |
                  AT32_DMA_CR_MSIZE_HWORD | AT32_DMA_CR_PSIZE_HWORD |
                  AT32_DMA_CR_MINC        | AT32_DMA_CR_TCIE        |
                  AT32_DMA_CR_TEIE;
  ...
  ADCD3.adc = ADC3;
  ADCD3.dmastp  = NULL;
  ADCD3.dmamode = AT32_DMA_CR_PL(AT32_ADC_ADC3_DMA_PRIORITY) |
                  AT32_DMA_CR_MSIZE_HWORD | AT32_DMA_CR_PSIZE_HWORD |
                  AT32_DMA_CR_MINC        | AT32_DMA_CR_TCIE        |
                  AT32_DMA_CR_TEIE;
...
#if AT32_ADC_USE_ADC2
    if (&ADCD2 == adcp) {
      adcp->dmastp = dmaStreamAllocI(AT32_DMA_STREAM_ID(0, 0),
...
#if AT32_ADC_USE_ADC3
    if (&ADCD3 == adcp) {
      adcp->dmastp = dmaStreamAllocI(AT32_DMA_STREAM_ID(2, 5),
