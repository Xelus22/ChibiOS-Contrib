...
#if 0
  /* Errata 2.4.6 for AT32F40x, Spurious Bus Error detection in Master mode.*/
...
static void i2c_lld_serve_error_interrupt(I2CDriver *i2cp, uint16_t sr) {
  ...
  if (sr & I2C_SR1_BERR) {                          /* Bus error.           */
    ...
    /* No more needed */
#if 0
    /* Errata 2.4.6 for AT32F40x, Spurious Bus Error detection in
       Master mode.*/
...
void i2c_lld_start(I2CDriver *i2cp) {
  ...
  if (i2cp->state == I2C_STOP) {
    ...
    if (&I2CD1 == i2cp) {
      ...
      rccEnableI2C1(true);
      nvicEnableVector(I2C1_EV_IRQn, AT32_I2C_I2C1_IRQ_PRIORITY);
      nvicEnableVector(I2C1_ER_IRQn, AT32_I2C_I2C1_IRQ_PRIORITY);
    ...
    if (&I2CD2 == i2cp) {
      ...
      rccEnableI2C2(true);
      nvicEnableVector(I2C2_EV_IRQn, AT32_I2C_I2C2_IRQ_PRIORITY);
      nvicEnableVector(I2C2_ER_IRQn, AT32_I2C_I2C2_IRQ_PRIORITY);
    ...
    if (&I2CD3 == i2cp) {
      ...
      rccEnableI2C3(true);
      nvicEnableVector(I2C3_EV_IRQn, AT32_I2C_I2C3_IRQ_PRIORITY);
      nvicEnableVector(I2C3_ER_IRQn, AT32_I2C_I2C3_IRQ_PRIORITY);
