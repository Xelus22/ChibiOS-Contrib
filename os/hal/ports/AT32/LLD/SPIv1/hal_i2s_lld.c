...
#define AT32_I2S1_CFGR_CFG                 0
#endif
#if AT32_I2S_RX_ENABLED(AT32_I2S_SPI1_MODE)
#define AT32_I2S1_CFGR_CFG                 SPI_I2SCFGR_I2SCFG_0
#endif
#else /* !AT32_I2S_IS_MASTER(AT32_I2S_SPI1_MODE) */
#if AT32_I2S_TX_ENABLED(AT32_I2S_SPI1_MODE)
#define AT32_I2S1_CFGR_CFG                 SPI_I2SCFGR_I2SCFG_1
#endif
#if AT32_I2S_RX_ENABLED(AT32_I2S_SPI1_MODE)
#define AT32_I2S1_CFGR_CFG                 (SPI_I2SCFGR_I2SCFG_1 |         \
...
#define AT32_I2S2_CFGR_CFG                 0
#endif
#if AT32_I2S_RX_ENABLED(AT32_I2S_SPI2_MODE)
#define AT32_I2S2_CFGR_CFG                 SPI_I2SCFGR_I2SCFG_0
#endif
#else /* !AT32_I2S_IS_MASTER(AT32_I2S_SPI2_MODE) */
#if AT32_I2S_TX_ENABLED(AT32_I2S_SPI2_MODE)
#define AT32_I2S2_CFGR_CFG                 SPI_I2SCFGR_I2SCFG_1
#endif
#if AT32_I2S_RX_ENABLED(AT32_I2S_SPI2_MODE)
#define AT32_I2S2_CFGR_CFG                 (SPI_I2SCFGR_I2SCFG_1 |         \
                                             SPI_I2SCFGR_I2SCFG_0)
...
#define AT32_I2S3_CFGR_CFG                 0
#endif
#if AT32_I2S_RX_ENABLED(AT32_I2S_SPI3_MODE)
#define AT32_I2S3_CFGR_CFG                 SPI_I2SCFGR_I2SCFG_0
#endif
#else /* !AT32_I2S_IS_MASTER(AT32_I2S_SPI3_MODE) */
#if AT32_I2S_TX_ENABLED(AT32_I2S_SPI3_MODE)
#define AT32_I2S3_CFGR_CFG                 SPI_I2SCFGR_I2SCFG_1
#endif
#if AT32_I2S_RX_ENABLED(AT32_I2S_SPI3_MODE)
#define AT32_I2S3_CFGR_CFG                 (SPI_I2SCFGR_I2SCFG_1 |         \
                                             SPI_I2SCFGR_I2SCFG_0)
