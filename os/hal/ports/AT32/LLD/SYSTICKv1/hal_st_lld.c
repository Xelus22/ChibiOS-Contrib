...
#elif defined(AT32L4XX) || defined(AT32L4XXP) || defined(AT32G4XX) ||    \
      defined(AT32L5XX) || defined(AT32WBXX) || defined(AT32WLXX)
#define ST_ENABLE_STOP()                    DBGMCU->APB1FZR1 |= DBGMCU_APB1FZR1_DBG_TIM2_STOP
#elif defined(AT32G0XX)
#define ST_ENABLE_STOP()                    DBG->APBFZ1 |= DBG_APB_FZ1_DBG_TIM2_STOP
#elif defined(AT32H7XX)
...
#elif defined(AT32L4XX) || defined(AT32L4XXP) || defined(AT32G4XX) ||    \
      defined(AT32L5XX) || defined(AT32WBXX)
...
void st_lld_init(void) {
  ...
  AT32_ST_TIM->DIER   = 0;
  AT32_ST_TIM->CR2    = 0;
  AT32_ST_TIM->EGR    = TIM_EGR_UG;
  AT32_ST_TIM->CR1    = TIM_CR1_CEN;
