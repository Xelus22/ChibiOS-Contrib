 ...
 * @brief   AT32 DAC subsystem low level driver source.
 *
 * @addtogroup DAC
 * @{
 */
...
#define DAC1_CH1_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC1_CH1_DMA_STREAM,                       \
                       AT32_DAC1_CH1_DMA_CHN)

#define DAC1_CH2_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC1_CH2_DMA_STREAM,                       \
                       AT32_DAC1_CH2_DMA_CHN)

#define DAC2_CH1_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC2_CH1_DMA_STREAM,                       \
                       AT32_DAC2_CH1_DMA_CHN)

#define DAC2_CH2_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC2_CH2_DMA_STREAM,                       \
                       AT32_DAC2_CH2_DMA_CHN)

#define DAC3_CH1_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC3_CH1_DMA_STREAM,                       \
                       AT32_DAC3_CH1_DMA_CHN)

#define DAC3_CH2_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC3_CH2_DMA_STREAM,                       \
                       AT32_DAC3_CH2_DMA_CHN)

#define DAC4_CH1_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC4_CH1_DMA_STREAM,                       \
                       AT32_DAC4_CH1_DMA_CHN)

#define DAC4_CH2_DMA_CHANNEL                                                \
  AT32_DMA_GETCHANNEL(AT32_DAC_DAC4_CH2_DMA_STREAM,                       \
                       AT32_DAC4_CH2_DMA_CHN)
...
#if AT32_DAC_USE_DAC1_CH1 == TRUE
static const dacparams_t dac1_ch1_params = {
  .dac          = DAC1,
  .dataoffset   = 0U,
  .regshift     = 0U,
  .regmask      = 0xFFFF0000U,
  .dmastream    = AT32_DAC_DAC1_CH1_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC1_CH1,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC1_CH1_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC1_CH1_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC1_CH1_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC1_CH2 == TRUE
static const dacparams_t dac1_ch2_params = {
  .dac          = DAC1,
  .dataoffset   = CHANNEL_DATA_OFFSET,
  .regshift     = 16U,
  .regmask      = 0x0000FFFFU,
  .dmastream    = AT32_DAC_DAC1_CH2_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC1_CH2,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC1_CH2_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC1_CH2_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC1_CH2_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC2_CH1 == TRUE
static const dacparams_t dac2_ch1_params = {
  .dac          = DAC2,
  .dataoffset   = 0U,
  .regshift     = 0U,
  .regmask      = 0xFFFF0000U,
  .dmastream    = AT32_DAC_DAC2_CH1_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC2_CH1,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC2_CH1_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC2_CH1_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC2_CH1_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC2_CH2 == TRUE
static const dacparams_t dac2_ch2_params = {
  .dac          = DAC2,
  .dataoffset   = CHANNEL_DATA_OFFSET,
  .regshift     = 16U,
  .regmask      = 0x0000FFFFU,
  .dmastream    = AT32_DAC_DAC2_CH2_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC2_CH2,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC2_CH2_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC2_CH2_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC2_CH2_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC3_CH1 == TRUE
static const dacparams_t dac3_ch1_params = {
  .dac          = DAC3,
  .dataoffset   = 0U,
  .regshift     = 0U,
  .regmask      = 0xFFFF0000U,
  .dmastream    = AT32_DAC_DAC3_CH1_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC3_CH1,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC3_CH1_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC3_CH1_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC3_CH1_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC3_CH2 == TRUE
static const dacparams_t dac3_ch2_params = {
  .dac          = DAC3,
  .dataoffset   = CHANNEL_DATA_OFFSET,
  .regshift     = 16U,
  .regmask      = 0x0000FFFFU,
  .dmastream    = AT32_DAC_DAC3_CH2_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC3_CH2,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC3_CH2_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC3_CH2_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC3_CH2_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC4_CH1 == TRUE
static const dacparams_t dac4_ch1_params = {
  .dac          = DAC4,
  .dataoffset   = 0U,
  .regshift     = 0U,
  .regmask      = 0xFFFF0000U,
  .dmastream    = AT32_DAC_DAC4_CH1_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC4_CH1,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC4_CH1_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC4_CH1_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC4_CH1_IRQ_PRIORITY
};
#endif

#if AT32_DAC_USE_DAC4_CH2 == TRUE
static const dacparams_t dac4_ch2_params = {
  .dac          = DAC4,
  .dataoffset   = CHANNEL_DATA_OFFSET,
  .regshift     = 16U,
  .regmask      = 0x0000FFFFU,
  .dmastream    = AT32_DAC_DAC4_CH2_DMA_STREAM,
#if AT32_DMA_SUPPORTS_DMAMUX
  .peripheral   = AT32_DMAMUX1_DAC4_CH2,
#endif
  .dmamode      = AT32_DMA_CR_CHSEL(DAC4_CH2_DMA_CHANNEL) |
                  AT32_DMA_CR_PL(AT32_DAC_DAC4_CH2_DMA_PRIORITY) |
                  AT32_DMA_CR_MINC | AT32_DMA_CR_CIRC | AT32_DMA_CR_DIR_M2P |
                  AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE | AT32_DMA_CR_HTIE |
                  AT32_DMA_CR_TCIE,
  .dmairqprio   = AT32_DAC_DAC4_CH2_IRQ_PRIORITY
};
#endif
...
#if (AT32_HAS_DAC1_CH2 || AT32_HAS_DAC2_CH2 ||                            \
     AT32_HAS_DAC3_CH2 || AT32_HAS_DAC4_CH2)
    else {
...
void dac_lld_start_conversion(DACDriver *dacp) {
  ...
  dacp->dma = dmaStreamAllocI(dacp->params->dmastream,
                              ...
                              (at32_dmaisr_t)dac_lld_serve_tx_interrupt,
                              (void *)dacp);
  ...
  dmaStreamSetMode(dacp->dma, dmamode            |
                              AT32_DMA_CR_DMEIE | AT32_DMA_CR_TEIE |
                              AT32_DMA_CR_HTIE  | AT32_DMA_CR_TCIE);
