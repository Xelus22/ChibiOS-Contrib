...
#define AT32_DMA_CR_EN             DMA_CCR_EN
#define AT32_DMA_CR_TEIE           DMA_CCR_TEIE
#define AT32_DMA_CR_HTIE           DMA_CCR_HTIE
#define AT32_DMA_CR_TCIE           DMA_CCR_TCIE
#define AT32_DMA_CR_DIR_MASK       (DMA_CCR_DIR | DMA_CCR_MEM2MEM)
#define AT32_DMA_CR_DIR_P2M        0U
#define AT32_DMA_CR_DIR_M2P        DMA_CCR_DIR
#define AT32_DMA_CR_DIR_M2M        DMA_CCR_MEM2MEM
#define AT32_DMA_CR_CIRC           DMA_CCR_CIRC
#define AT32_DMA_CR_PINC           DMA_CCR_PINC
#define AT32_DMA_CR_MINC           DMA_CCR_MINC
#define AT32_DMA_CR_PSIZE_MASK     DMA_CCR_PSIZE
#define AT32_DMA_CR_PSIZE_BYTE     0U
#define AT32_DMA_CR_PSIZE_HWORD    DMA_CCR_PSIZE_0
#define AT32_DMA_CR_PSIZE_WORD     DMA_CCR_PSIZE_1
#define AT32_DMA_CR_MSIZE_MASK     DMA_CCR_MSIZE
#define AT32_DMA_CR_MSIZE_BYTE     0U
#define AT32_DMA_CR_MSIZE_HWORD    DMA_CCR_MSIZE_0
#define AT32_DMA_CR_MSIZE_WORD     DMA_CCR_MSIZE_1
#define AT32_DMA_CR_SIZE_MASK      (AT32_DMA_CR_PSIZE_MASK |              \
                                     AT32_DMA_CR_MSIZE_MASK)
#define AT32_DMA_CR_PL_MASK        DMA_CCR_PL
...
#define AT32_DMA_ISR_TEIF          DMA_ISR_TEIF1
#define AT32_DMA_ISR_HTIF          DMA_ISR_HTIF1
#define AT32_DMA_ISR_TCIF          DMA_ISR_TCIF1
/** @} */
...
#define dmaStreamEnable(dmastp) {                                           \
  (dmastp)->channel->CCR |= AT32_DMA_CR_EN;                                \
}
...
#define dmaStreamDisable(dmastp) {                                          \
  (dmastp)->channel->CCR &= ~(AT32_DMA_CR_TCIE | AT32_DMA_CR_HTIE |       \
...
#define dmaStreamClearInterrupt(dmastp) {                                   \
  (dmastp)->dma->IFCR = AT32_DMA_ISR_MASK << (dmastp)->shift;              \
}
