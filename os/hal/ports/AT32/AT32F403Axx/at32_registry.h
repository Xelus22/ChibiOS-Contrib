...
/**
 * @file    AT32F403Axx/at32_registry.h
 * @brief   AT32F403Axx capabilities registry.
 *
 * @addtogroup HAL
 * @{
 */
...
// Has DAC2 but not shown how to access in ref manual
...
#define AT32_TIM2_IS_32BITS                FALSE
...
#define AT32_TIM5_IS_32BITS                FALSE
...
#define AT32_FSMC_IS_FMC                   FALSE
#define AT32_FSMC_HANDLER                  Vector100
#define AT32_FSMC_NUMBER                   48

/* CRC attributes.*/
#define AT32_HAS_CRC                       TRUE
#define AT32_CRC_PROGRAMMABLE              FALSE
/** @} */
#endif /* defined(AT32F10X_XL) */
